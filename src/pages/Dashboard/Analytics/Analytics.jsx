    ...
    <div className="p-6">
      ...
      <div className="stats shadow w-full mb-10 bg-base-100 border">
        ...
        <div className="stat">
          ...
          <div className="stat-desc">Services assigned/completed</div>
        </div>
      </div>

      <div className="bg-white p-6 rounded-lg shadow-lg">
        <h3 className="text-xl font-bold mb-4 text-center">Service Demand Chart (Bookings per Service)</h3>
        <div className="h-[400px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip />
              <Legend />
              <Bar dataKey="bookings" fill="#8884d8"  label={{ position: 'top' }}>
